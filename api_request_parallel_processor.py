...
The script is structured as follows:
    ...
    *** different model inputs, refer to https://github.com/itayzit/openai-async/blob/main/openai_async/openai_async.py
"""
...
class APIRequest:
    ...
    async def call_api(
        ...
        logging.info(f"Starting request 112#{self.task_id}")
        error = None
        try:
            ...
            logging.info(f"Starting request 113#{self.task_id}")
...
if __name__ == "__main__":
    ...
    '''
    parser.add_argument("--requests_filepath",default="example_requests_to_parallel_process.jsonl")
    parser.add_argument("--save_filepath", default=None)
    parser.add_argument("--request_url", default="https://api.openai.com/v1/embeddings")
    parser.add_argument("--api_key", default="Your Key")
    parser.add_argument("--max_requests_per_minute", type=int, default=20 * 0.5)
    parser.add_argument("--max_tokens_per_minute", type=int, default=40000 * 0.5)
    parser.add_argument("--token_encoding_name", default="cl100k_base")
    parser.add_argument("--max_attempts", type=int, default=5)
    parser.add_argument("--logging_level", default=logging.INFO)
