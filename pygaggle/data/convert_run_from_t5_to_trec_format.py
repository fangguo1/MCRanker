"""Script to convert T5 predictions into a TREC-formatted MCRanker_run."""
import argparse
import collections


parser = argparse.ArgumentParser(
    description='Convert T5 predictions into a TREC-formatted MCRanker_run.')
...
parser.add_argument('--output', type=str, required=True, help='MCRanker_run file in the TREC format.')
