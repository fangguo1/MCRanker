...
queries and the retrieval MCRanker_run file for the queries and then
...
parser = argparse.ArgumentParser(
    description='Create T5-formatted input from Robust04 queries, MCRanker_run and corpus.')
