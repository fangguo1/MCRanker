...
if __name__ == '__main__':
    ...
    parser.add_argument('--cbqa-device', type=str, required=False, default='cuda:0', help="Device to MCRanker_run inference on")
    ...
    parser.add_argument('--reader-device', type=str, required=False, default='cuda:0', help="Device to MCRanker_run inference on")
    ...
    if args.type == 'openbook':
        if args.qa_reader == 'dpr':
            ...
            # MCRanker_run a warm up question
